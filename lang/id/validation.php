...
return [
    ...
    */
    ...
    'between'              => [
        ...
        'file'    => 'Bidang :attribute harus antara :min dan :max KB.',
    ...
    'gt'                   => [
        ...
        'file'    => 'Bidang :attribute harus lebih besar dari :value KB.',
    ...
    'gte'                  => [
        ...
        'file'    => 'Bidang :attribute harus lebih besar dari atau sama dengan :value KB.',
    ...
    'lt'                   => [
        ...
        'file'    => 'Bidang :attribute harus kurang dari :value KB.',
    ...
    'lte'                  => [
        ...
        'file'    => 'Bidang :attribute harus kurang dari atau sama dengan :value KB.',
    ...
    'max'                  => [
        ...
        'file'    => 'Bidang :attribute seharusnya tidak lebih dari :max KB.',
    ...
    'min'                  => [
        ...
        'file'    => 'Bidang :attribute harus minimal :min KB.',
        'string'  => 'Isian :attribute harus minimal :min karakter.',
        'array'   => 'Isian :attribute harus minimal :min item.',
    ],
    'not_in'               => 'Isian :attribute harus lebih dari :values.',
    'not_regex'            => 'Format isian :attribute tidak valid.',
    'numeric'              => 'Isian :attribute harus berupa angka (Gunakan Titik Untuk Koma)',
    'present'              => 'Bidang isian :attribute wajib ada.',
    'regex'                => 'Format isian :attribute tidak valid.',
    'required'             => 'Bidang isian :attribute wajib diisi.',
    'required_if'          => 'Bidang isian :attribute wajib diisi.',
    ...
    */
    ...
    'custom' => [
        'qty.*' => [
            'required' => 'isian qty wajib diisi.',
            'numeric' => 'Isian rak harus berupa angka.',
            'not_in' => 'isian qty harus lebih dari :values.',
            'max' => 'Isian qty seharusnya tidak lebih dari :max.'
        ],
        'qty_retur.*' => [
            'required' => 'isian Qty Retur wajib diisi.',
            'numeric' => 'Isian rak harus berupa angka.',
            'not_in' => 'isian Qty Retur harus lebih dari :values.',
            'max' => 'Isian Qty Retur seharusnya tidak lebih dari :max.',
            'min' => 'Isian Qty Retur seharusnya tidak kurang dari :min.'
        ],
        'rak_id.*' => [
            'required' => 'Isian rak wajib diisi.',
            'in' => 'Isian rak yang dipilih tidak valid.',
            'different' => 'Isian rak tujuan dan rak asal harus berbeda.'
        ],
        'margin_resep.*' => [
            'required_if' => 'Bidang isian Harga Jual Resep wajib diisi bila Tipe adalah obat',
        ],
        'harga_jual_resep.*' => [
            'required_if' => 'Bidang isian Harga Jual Resep wajib diisi bila Tipe adalah obat',
        ],
        'tanggal_jatuh_tempo' => [
            'required_if' => 'Bidang isian Tanggal Jatuh Tempo wajib diisi bila Tipe Pembayaran adalah Kredit',
        ],
        'tanggal_kadaluarsa.*' => [
            'date' => 'Isian tanggal kadaluarsa bukan tanggal yang valid.',
            'required_if' => 'Bidang isian Tanggal Kadaluarsa wajib diisi bila Tipe adalah Obat',
        ],
        'nomor_batch.*' => [
            'required_if' => 'Bidang isian Nomor Batch wajib diisi bila Tipe adalah Obat',
        ],
