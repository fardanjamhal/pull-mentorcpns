<template>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr>
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" v-for="category in categories">
                    <div class="card border-bottom border-3 border-0">
                        ...
                        <card class="card-header">
                            ...
                            <p class="card-text">Pelajari dan pahami sebaik mungkin materi yang tersedia. supaya kamu lulus terpilih di kategori ini.</p>
                        </card>
                        <div class="card-body">
                            <Link :href="`/user/categories/${category.id}/lesson-categories`" class="btn btn-outline-primary btn-sm w-100">Selengkapnya</Link>
                        </div>
                    </div>
                </div>
            </div>
