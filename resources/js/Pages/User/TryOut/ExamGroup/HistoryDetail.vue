            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="ms-auto" v-if="history.exam_group.certificate_print_user == 1">
                            <a target="_blank" :href="`/user/exam-groups/${history.id}/export-pdf`" class="btn btn-danger btn-sm m-1">Cetak Hasil Try Out</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        computed: {
            totalAbovePassingGrade() {
                return this.history.exam_group.grade.reduce((total, grade) => {
                    ...
                    const passingGrade = parseFloat(grade.exam.question_title.passing_grade ?? 0);
