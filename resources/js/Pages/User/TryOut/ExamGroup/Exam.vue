    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" style="width: 25vh;" v-for="(exam, index) in examGroups.data" :key="index">
                    <div class="card border-bottom border-3 border-0">       
                        ...
                        <div class="card-header">
                            ...
                            <!-- <p class="card-text">Kerjakan Try Out Sesuai Perintah Yang Ada Dalam Informasi.</p> -->
                        </div>
                                ...
                                <div v-if="$page.props.auth.user.member_type == 2">
                                    <div v-if="$page.props.setting.purchase_type == 1">
                                        <div v-if="exam.transaction.length > 0">
                                            <Link :href="`/user/exam-groups/${lessonCategory.category_id}/lesson-categories/${lessonCategory.id}/exams/${exam.id}`" class="btn btn-primary btn-sm w-100">Kerjakan Try Out</Link>
                                        </div>
                                        <div v-else>
                                            <button class="btn btn-outline-primary btn-sm w-100" @click="buyExam(exam.id)">Beli Try Out</button>         
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="$page.props.setting.purchase_type == 3">
                                        <div v-if="exam.transaction.length > 0 && checkMemberCategories(exam.member_categories) == true">
                                            <Link :href="`/user/exam-groups/${lessonCategory.category_id}/lesson-categories/${lessonCategory.id}/exams/${exam.id}`" class="btn btn-primary btn-sm w-100 mb-2">Kerjakan Try Out</Link>
                                        </div>
                                        ...
                                        <div v-if="exam.transaction.length == 0">
                                            <button class="btn btn-outline-primary btn-sm w-100 mb-2" @click="buyExam(exam.id)">Beli Try Out</button>       
                                        </div>
