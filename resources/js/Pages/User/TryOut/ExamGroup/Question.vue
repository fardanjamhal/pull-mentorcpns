                                    ...
                                    <tr v-for="(answer, index) in (questionLists[indexPage]['answer_order'].split(','))" :key="index">
                                        <span>
                                            <td width="50" style="padding: 10px;">
                                                <button v-if="answer == getMyAnswer(questionLists[indexPage]['question_id'])"  @click="submitAnswer(questionLists[indexPage]['question_id'], answer)" class="btn btn-danger text-white">{{ options[index] }}</button>
