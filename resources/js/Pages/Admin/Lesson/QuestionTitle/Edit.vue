<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Paket Soal</title>
    </Head>
    <!--start page wrapper -->
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                category_id: props.questionTitle.category_id,
                lesson_category_id: props.questionTitle.lesson_category_id,
                lesson_id: props.questionTitle.lesson_id,
                name: props.questionTitle.name,
                total_choices: props.questionTitle.total_choices,
                total_section: props.questionTitle.total_section,
                add_value_category: props.questionTitle.add_value_category,
                assessment_type: props.questionTitle.assessment_type,
                show_answer: props.questionTitle.show_answer,
                passing_grade: props.questionTitle.passing_grade,
                minimum_grade: props.questionTitle.minimum_grade,

                lessonCategories: [],
                lessons: [],
            });

            // bind data lesson by lesson category id
            ...
            const submit = () => {
                // send data to server
                Inertia.put(`/admin/question-titles/${props.questionTitle.id}`, {
                    // data
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Paket Soal Berhasil Diupdate!.',
                            icon: 'success',
