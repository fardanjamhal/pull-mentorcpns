<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Latihan Soal</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Latihan Soal</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                lesson_category_id: props.exam.lesson_category_id,
                ...
                price_before_discount: props.exam.price_before_discount,
                price_after_discount: props.exam.price_after_discount,
                ...
                member_categories: !props.exam.member_categories ? [] : props.exam.member_categories.map(item => {
                    return { 'name': item };
                }),
