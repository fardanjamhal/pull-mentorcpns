<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit FAQ</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <div class="ms-auto">
                            <Link href="/admin/faqs" class="btn btn-primary btn-sm mt-2 mt-lg-0">Kembali</Link>
                        </div>
                    </div>
                    <form @submit.prevent="submit" class="row g-3">
                        <div class="col-12">
                            <label class="form-label">Pertanyaan</label>
                            <input type="text" class="form-control" v-model="form.question" :class="{ 'is-invalid': errors.question }" placeholder="Nama">
    ...
    export default {
        ...
        setup(props) {
          ...
          // submit method
            const submit = () => {
                // send data to server
                Inertia.put(`/admin/faqs/${props.faq.id}`, {
                    // data
