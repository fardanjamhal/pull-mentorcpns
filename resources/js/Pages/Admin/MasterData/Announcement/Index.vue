                                ...
                                <tr v-for="(announcement, index) in announcements.data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/announcements/${announcement.id}`" class="ms-1"><i class='bx bx-grid-alt'></i></Link>
                                            <Link :href="`/admin/announcements/${announcement.id}/edit`" class="ms-1"><i class='bx bxs-edit'></i></Link>
                                            <a href="#" @click.prevent="destroy(announcement.id)" class="ms-1"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="4" v-if="!announcements.data.length">Data Tidak Tersedia</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
