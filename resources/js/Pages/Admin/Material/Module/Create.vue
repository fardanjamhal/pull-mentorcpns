<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah Materi / Modul</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Materi / Modul</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea cols="30" rows="10" class="form-control" v-model="form.description" :class="{ 'is-invalid': errors.description }" placeholder="Deskripsi Materi / Modul"></textarea>
            ...
            const submit = () => {
                ...
                Inertia.post('/admin/modules', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Materi / Modul Berhasil Disimpan!.',
                            icon: 'success',
