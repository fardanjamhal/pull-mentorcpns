            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link href="/admin/modules/create" class="btn btn-primary btn-sm mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Materi / Modul</Link>
                        </div>
                    </div>
                                ...
                                <tr v-for="(module, index) in modules.data" :key="index">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/modules/${module.id}/edit`" class="ms-1"><i class='bx bxs-edit'></i></Link>
