<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Materi / Modul</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Materi / Modul</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea cols="30" rows="10" class="form-control" v-model="form.description" :class="{ 'is-invalid': errors.description }" placeholder="Deskripsi Modul"></textarea>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                category_id: props.module.category_id,
                member_categories: !props.module.member_categories ? [] : props.module.member_categories.map(item => {
                    return { 'name': item };
                })
            });
            ...
            const submit = () => {
                // send data to server
                Inertia.put(`/admin/modules/${props.module.id}`, {
                    // data
