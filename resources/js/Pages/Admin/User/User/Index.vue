                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr v-for="(user, index) in users.data" :key="index">
                                    ...
                                    <td>{{ user.name }}</td>
                                    <td>Email : {{ user.email ?? '-' }} <br> Username : {{ user.username ?? '-' }}</td>
                                    <td><span class="badge bg-success">{{ user.level == 1 ? 'Admin' : 'Siswa' }}</span></td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link :href="`/admin/users/${user.id}`" class="ms-1"><i class='bx bx-grid-alt'></i></Link>
                                            <Link :href="`/admin/users/${user.id}/edit`" class="ms-1"><i class='bx bxs-edit'></i></Link>
                                            <a href="#" @click.prevent="destroy(user.id)" class="ms-1"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
